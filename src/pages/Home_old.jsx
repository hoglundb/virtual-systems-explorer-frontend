...
const MENU_ITEMS = [
  ...
  { label: "Maintenance Procedures", route: "/procedures", active: true },
    ...
    <div style={{ display: "flex", width: "100%", height: "100%", background: BG }}>
      ...
      <div style={{
        ...
        <div style={{ borderBottom: `1px solid ${CYAN_DIM}`, paddingBottom: "16px" }}>
          ...
          <div style={{ fontSize: "13px", fontWeight: "bold", letterSpacing: "1px", color: TITLE_COLOR, marginTop: "4px" }}>{user?.username}</div>
        </div>
